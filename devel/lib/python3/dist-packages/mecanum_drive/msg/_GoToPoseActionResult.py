...
"""autogenerated by genpy from mecanum_drive/GoToPoseActionResult.msg. Do not edit."""
import codecs
import sys
...
class GoToPoseActionResult(genpy.Message):
  ...
  _type = "mecanum_drive/GoToPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mecanum_drive/GoToPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = mecanum_drive.msg.GoToPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mecanum_drive.msg.GoToPoseResult()
