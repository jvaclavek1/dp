...
(cl:defmethod cl:initialize-instance :after ((m <GoToPoseResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoToPoseResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_drive-msg:<GoToPoseResult> is deprecated: use mecanum_drive-msg:GoToPoseResult instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <GoToPoseResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_drive-msg:success-val is deprecated.  Use mecanum_drive-msg:success instead.")
  (success m))
