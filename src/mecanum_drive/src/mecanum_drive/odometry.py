...
from mecanum_drive import encoder
...
class Odometry:
    ...
    def __init__(self):
        self.frontLeftEncoder = encoder.Encoder()
        self.frontRightEncoder = encoder.Encoder()
        self.rearLeftEncoder = encoder.Encoder()
        self.rearRightEncoder = encoder.Encoder()
        self.pose = pose.Pose()
        self.lastTime = 0
        self.lastYawDeg = 0
        self.currentYawDeg = 0
        self.wheelSeparation = 0
        self.wheelSeparationLength = 0
