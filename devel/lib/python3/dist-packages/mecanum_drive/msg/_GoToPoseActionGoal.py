...
"""autogenerated by genpy from mecanum_drive/GoToPoseActionGoal.msg. Do not edit."""
import codecs
import sys
...
class GoToPoseActionGoal(genpy.Message):
  ...
  _type = "mecanum_drive/GoToPoseActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','mecanum_drive/GoToPoseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = mecanum_drive.msg.GoToPoseGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = mecanum_drive.msg.GoToPoseGoal()
